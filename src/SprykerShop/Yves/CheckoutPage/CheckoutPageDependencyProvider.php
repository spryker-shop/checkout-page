...
use SprykerShop\Yves\CheckoutPage\Plugin\StepEngine\PaymentExternalSubFormPlugin;
...
class CheckoutPageDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    public function provideDependencies(Container $container): Container
    {
        ...
        $container = $this->addPaymentExternalSubFormPlugin($container);
     ...
     * @return \Spryker\Yves\Kernel\Container
     */
    protected function addPaymentExternalSubFormPlugin(Container $container): Container
    {
        $container->set(static::PLUGIN_EXTERNAL_PAYMENT_SUB_FORM, $container->factory(function () {
            return new PaymentExternalSubFormPlugin();
        }));
